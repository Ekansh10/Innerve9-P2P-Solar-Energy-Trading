...
const upgradeAuxiliary = async function (url, version, operation, contractsLocation) {
    // Register EndUser
    ...
    await got.post(`${url}/chaincodes`, {
        json: {
            ...
            "chaincodeName": "datasharingmg",
            "chaincodePath": `${contractsLocation}/DataSharingRequest_mg`,
            "chaincodeType": "node",
            "chaincodeVersion": version,
            "metadataPath": `${contractsLocation}/DataSharingRequest_mg/META-INF`
        },
        responseType: 'json',
        headers: {
    ...
    // instantiate datasharingmg
    await got.post(`${url}/channels/auxiliary/chaincodes${operation}`, {
        json: {
            "chaincodeName": "datasharingmg",
            "chaincodeType": "node",
            "chaincodeVersion": version,
...
upgradeAuxiliary(url, version, operation, location).then(res => {
    console.log('done')
})
...
const upgradeDirectContract = async function (url, version, operation, contractsLocation) {
    // Register EndUser
    ...
    await got.post(`${url}/chaincodes`, {
        json: {
            ...
            "chaincodeName": "directcontractsmg",
            "chaincodePath": `${contractsLocation}/DirectTrading_mg`,
            "chaincodeType": "node",
            "chaincodeVersion": version,
            "metadataPath": `${contractsLocation}/DirectTrading_mg/META-INF`
        },
        responseType: 'json',
        headers: {
    ...
    // install contract on retailers peers
    await got.post(`${url}/chaincodes`, {
        json: {
...
upgradeDirectContract(url, version, operation, location).then(res => {
    console.log('done')
})
